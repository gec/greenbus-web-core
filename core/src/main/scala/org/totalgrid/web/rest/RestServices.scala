 ...
 */
package org.totalgrid.web.rest
...
import org.totalgrid.web.models.ControlMessages.CommandExecuteRequest
import org.totalgrid.web.models.ExceptionMessages.ExceptionMessage
import org.totalgrid.web.models.EntityWithChildren
import org.totalgrid.web.reefpolyfill.FrontEndService
import org.totalgrid.web.util.Timer
...
trait RestServices extends ReefAuthentication {
  self: Controller =>
  import org.totalgrid.web.models.JsonFormatters._
  ...
  def getEquipmentRoots( modelId: String, rootTypes: List[String], childTypes: List[String], depth: Int, limit: Int) = ReefClientActionAsync { (request, session) =>
    import org.totalgrid.web.models.EntityWithChildren._
...
//      }
  ...
  def postCommandLock( modelId: String)  = ReefClientActionAsync { (request, session) =>
    import org.totalgrid.web.models.ControlMessages._
