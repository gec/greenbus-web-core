...
import org.totalgrid.web.connection.{ConnectionManagerRef, ConnectionStatus}
...
trait ReefAuthentication extends LoginLogout with ConnectionManagerRef {
  ...
  import org.totalgrid.web.auth.AuthTokenLocation._
  import org.totalgrid.web.connection.ConnectionStatus._
  import org.totalgrid.web.connection.ReefConnectionManager
